                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row g-2 mb-2">
                                    <div class="col-3">
                                        ...
                                        <input type="text" name="numero_item" class="form-control form-control-sm"
                                            value="{{ old('numero_item') }}">
                                    </div>
                                    <div class="col-5">
                                        <label class="form-label small mb-1">CITE Memorandum</label>
                                        <input type="text" name="cite_memorandum" class="form-control form-control-sm"
                                            value="{{ old('cite_memorandum') }}">
                                    </div>
                                    <div class="col-4">
                                        ...
                                        <select name="designacion" class="form-select form-select-sm">
                                            ...
                                            <option value="Interinato" {{ old('designacion') == 'Interinato' ? 'selected' : '' }}>
                                                Interinato</option>
                                            <option value="Comisión" {{ old('designacion') == 'Comisión' ? 'selected' : '' }}>
                                                Comisión</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="unidad" id="unidad" class="form-select form-select-sm"
                                            onchange="cargarSubUnidades()">
                                            <option value="">Seleccionar Unidad</option>

                                            <option value="GERENCIA REGIONAL LA PAZ - GRLPZ">
                                                GERENCIA REGIONAL LA PAZ - GRLPZ
                                            </option>

                                            <option value="Unidad Administrativa">
                                                Unidad Administrativa
                                            </option>

                                            <option value="Unidad Fiscalización">
                                                Unidad Fiscalización
                                            </option>

                                            <option value="Unidad Jurídica">
                                                Unidad Jurídica
                                            </option>

                                            <option value="Administración Aduana Interior La Paz">
                                                Administración Aduana Interior La Paz
                                            </option>

                                            <option value="Aduana Frontera Guayaramerín">
                                                Aduana Frontera Guayaramerín
                                            </option>

                                            <option value="Aduana Aeropuerto El Alto">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-4">
                                        <input type="text" name="nombre" class="form-control form-control-sm"
                                            placeholder="Nombres" value="{{ old('nombre') }}">
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="mb-2">
                                    <input type="text" name="cargo" class="form-control form-control-sm"
                                        placeholder="Ingresar nombre del cargo..." value="{{ old('cargo') }}">
                                </div>

                                <div class="row g-2 mb-3">
                                    <div class="col-6">
                                        <label class="form-label small mb-1">Fecha de ingreso a la Aduana</label>
                                        <input type="date" name="fecha_ingreso_aduana" class="form-control form-control-sm"
                                            value="{{ old('fecha_ingreso_aduana') }}">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small mb-1">Fecha de inicio cargo</label>
                                        <input type="date" name="fecha_inicio_cargo" class="form-control form-control-sm"
                                            value="{{ old('fecha_inicio_cargo') }}">
                                    </div>
                                </div>
                        ...
                        <div class="card shadow-sm border-0 rounded-3">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <label class="btn btn-sm btn-outline-secondary mb-0">
                                            Subir Imagen <input type="file" n
                                       ame="fotografia" accept="image/*" class="d-none" onchange="previewImg(event,'preview-cons')">
                                        </label>
...
function cargarSubUnidades() {
    ...
    const subUnidad = document.getElementById("sub_unidad");

    subUnidad.innerHTML = '<option value="">Seleccionar Sub-Unidad</option>';
